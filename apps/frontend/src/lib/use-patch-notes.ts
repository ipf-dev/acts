...
export const patchNotes: readonly PatchNoteEntryView[] = [
  {
    version: "1.2.0",
    date: "2026-04-24",
    title: "프로젝트 관리 추가 및 에셋 설명 링크화",
    highlights: [
      "프로젝트 관리 기능 추가 — 팀 단위로 진행 중인 사업과 관련된 에셋을 모아 관리할 수 있습니다.",
      "프로젝트 상세에서 기존 에셋을 연결하거나, 새 파일을 직접 업로드해 프로젝트에 연결할 수 있습니다.",
      "프로젝트 생성 시 담당 팀과 마감일을 지정하거나, 마감일이 없는 상시 프로젝트로 운영할 수 있습니다.",
      "에셋 설명 안의 URL을 클릭해 한 번에 이동할 수 있습니다. [텍스트](URL) 마크다운 문법과, 텍스트를 선택한 뒤 URL을 붙여넣는 자동 변환도 지원합니다."
    ]
  },
  {
    version: "1.1.0",
