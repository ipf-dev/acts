...
1. Create the production PostgreSQL instance and database credentials.
...
8. Deploy the video preview Lambda image and connect its function name to the web service.
9. Smoke test health, Google login, asset upload, download, preview, and admin pages.
10. Add a custom domain after the default service URL is working.
